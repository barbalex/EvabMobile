...
#Hilfe erwünscht
Ich bin Biologe. Mit Access-Datenbanken und deren Steuerung mit Visual Basic habe ich einige Erfahrung. Was JavaScript, jQuery, jQuery mobile, Phonegap, CouchDb, Java/Android SDK für Android-Apps und Cocoa/Objective-C für iOS-Apps anbelangt, war ich ein blutiger Anfänger und befinde mich in einer steilen - und schlüpfrigen - Lernkurve. Es hilft auch nicht, dass HTML5, CouchDb, jQuery mobile und Phonegap am Beginn bzw. mitten in einer rasanten Entwicklung stehen und die aktuellen Browser auf die verwendeten, neuen HTML5-Elemente unterschiedlich reagieren - und das kann mit jedem Update ändern... Wäre toll, wenn sich noch jemand für dieses Projekt engagieren würde!
