...
#Hilfe erwünscht
Ich bin Biologe. Mit Access-Datenbanken und deren Steuerung mit Visual Basic kann ich umgehen. Was JavaScript, jQuery, jQuery mobile, Phonegap, CouchDb, Java/Android SDK für Android-Apps und Cocoa/Objective-C für iOS-Apps anbelangt, war ich ein blutiger Anfänger und befinde mich in einer steilen und schlüpfrigen Lernkurve. Es hilft auch nicht, dass HTML5, CouchDb, jQuery mobile, Phonegap und die modernen Browser sich rasant entwickeln. Wäre toll, wenn sich noch jemand für dieses Projekt engagieren würde!
