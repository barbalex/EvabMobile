...
#Hilfe erwünscht
Ich bin Biologe. JavaScript, jQuery, jQuery mobile, Phonegap, CouchDb, Java/Android SDK für Android-Apps und Cocoa/Objective-C für iOS-Apps waren soeben noch Fremdwörter. Ich befinde mich in einer steilen und schlüpfrigen Lernkurve. Es hilft nicht, dass HTML5, CouchDb, jQuery mobile, Phonegap und die modernen Browser sich rasant entwickeln - auch wenn die kommenden Möglichkeiten faszinierend sind. Wäre toll, wenn sich noch jemand für dieses Projekt engagieren würde!
